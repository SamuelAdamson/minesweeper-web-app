export const GitHub = require('./socials/github.png').default.src
export const Instagram = require('./socials/instagram.png').default.src
...
export const Layer1 = require('./algo/layer1.png').default.src
export const Layer2 = require('./algo/layer2.png').default.src